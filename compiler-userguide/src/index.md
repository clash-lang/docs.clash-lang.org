...
The table of contents in the sidebar (which can be opened in the menu on the
top-left)  allows easy access to different pages in the documentation. You can
...
developed by QBayLogic B.V., volunteers and students. The Clash Team always
appreciates feedback and contributions to the project to help improve the
...
the [GitHub repository](https://github.com/clash-lang/docs.clash-lang.org).
